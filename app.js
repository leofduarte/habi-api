...
app.use(cors({
  origin: [process.env.FRONTEND_URL, 'https://www.habi-app.pt', "https://www.habi-app.pt", "http://localhost:5174", "http://localhost:8080", "https://localhost:5174", process.env.BACKEND_URL, "192.168.1.182:5174"
  ],
